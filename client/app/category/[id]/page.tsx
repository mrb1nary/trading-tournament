...
export default function CategoryPage({ params }: { params: Promise<Params> }) {
  const { id } = use(params) as { id: string }; // Access the dynamic route parameter (e.g., 12p10, 12p25, etc.)
